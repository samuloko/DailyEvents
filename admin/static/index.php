<?php
//inicia uma nova sessão para o usuário, ou acaba com a existente
session_start();
unset($_SESSION);
session_destroy();
?>
<head>
  ...
  <!------ chama as funções externas de css para a página ---------->
...
/* colocando os parametros para a responsividade */
...
<div class="main">
    <div class="container">
      ...
      <?php
      //verificação para mensagem de login inválido
      ...
      ?>
        <form action="valida.php" method="post">
          ...
          <span class="fa fa-user"></span><input type="text"  Placeholder="Usuário" name="usuario" id="txUsuario" style="font-size:20px" required>
          </div>
            </div>
            <div class="row">
            <div class="form-group col-md-12 col-sm-4">

              <p><span class="fa fa-lock"></span><input type="password"  Placeholder="Senha" name="senha" id="txSenha" style="font-size:20px" required></p>
              </div>
